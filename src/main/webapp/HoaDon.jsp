...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3"> Hóa đơn</h1>
...
<div class="container justify-content-end">
    <form action="/locHoaDon" method="get">
        ...
        <label style="margin-left: 10px" >Ngày kết thúc :</label>
            <input type="date" name="ngayKT">

        <button type="submit" class="btn-success btn" style="border-radius: 5px;margin-left: 10px">Lọc</button>
    </form>
</div>
<div class="container col-md-11">
    ...
    <table class="table table-bordered table-striped">
        ...
        <c:forEach items="${listHDbyKH}" var="c">
            <tr>
                <th scope="row">${c.id}</th>
                <td>${c.khachHang.ten}</td>
                <td>${c.ma}</td>
                <td><f:formatDate value="${c.ngayTao}" pattern="dd/MM/yyyy"/></td>
                <td><f:formatDate value="${c.ngayThanhToan}" pattern="dd/MM/yyyy"/></td>
                <td>${c.tenNguoiNhan}</td>
                <td>${c.diaChi}</td>
                <td>${c.sdt}</td>
                <td>
                    <c:if test="${c.tinhTrang== 0}">
                        Chưa thanh toán
                    </c:if>
                ...
                <td>
                    <a href="/viewHDCT?idhd=${c.id}" type="button" class="btn btn-success " style="border-radius:5px ">Detail</a>
                </td>
