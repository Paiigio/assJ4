      ...
      <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
        ...
        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
          <div class="navbar-nav mr-auto py-0">
            <a href="/TrangChu" class="nav-item nav-link">Trang Chủ</a>
            <a href="/TrangChu#SanPham" class="nav-item nav-link">Sản phẩm</a>
            <a href="/viewHoaDon" class="nav-item nav-link">Hóa Đơn</a>
            <div class="nav-item ">
              <a href="/viewGH" class="nav-link" >Giỏ hàng</a>
