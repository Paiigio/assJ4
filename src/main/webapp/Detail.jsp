      ...
      <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
        <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
          <div class="nav-item dropdown">
            <a href="#" class="nav-link" data-toggle="dropdown">Quản lý <i class="fa fa-angle-down float-right mt-1"></i></a>
...
<!-- Shop Detail Start -->
<form action="/addSPGH" method="post" class="container-fluid py-5">
  <div class="row px-xl-5">
    <div class="col-lg-5 pb-5 float-left">
      <input type="hidden" name="idSP" value="${detail.id}">
      <div id="product-carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner border">
          <div class="carousel-item active">
            <img class="w-100 h-100" src='/hinh/${detail.hinh}' alt="Image">
          </div>
          </div>
        </div>
    ...
    <div class=" col-lg-7 pb-5 float-right">
      <h3 class="font-weight-semi-bold">${detail.sanPham.ten} ${detail.mauSac.ten} ${detail.nsx.ten}</h3>
      ...
      <h3 class="font-weight-semi-bold mb-4"><f:formatNumber type="currency" value="${detail.giaBan}"/></h3>
      <p class="mb-4">${detail.moTa}</p>
      ...
      <div class="owl-carousel related-carousel">
        ...
        <div class="card product-item border-0">
          <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
            <img class="img-fluid w-100" src='/hinh/${sp.hinh}' style="height: 300px" alt="">
          </div>
          <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
            <h6 class="text-truncate mb-3">${sp.sanPham.ten} ${sp.mauSac.ten}</h6>
            <div class="d-flex justify-content-center">
              <h6><f:formatNumber type="currency" value="${sp.giaBan}"/></h6><h6 class="text-muted ml-2"><del>${sp.giaNhap}</del></h6>
            </div>
          </div>
